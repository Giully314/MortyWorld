...
{
    public Trunk2(Handler handler, float x, float y)
    {
    ...
    {
        graphics.drawImage(Assets.trunk_2, (int)(coord_x - handler.getGameCamera().getOffsetX()), (int)(coord_y - handler.getGameCamera().getOffsetY()), entity_width, entity_height,  null);
    }
}